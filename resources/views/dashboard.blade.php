                            ...
                            <ul class="list-unstyled mb-0">
                                @foreach ($overtimeRequests as $ot)
                                    <li class="mb-2 d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
{{ optional($ot->starts_at)->format('M d, Y h:i A') ?? 'N/A' }}
{{ optional($ot->ends_at)->format('M d, Y h:i A') ?? 'N/A' }}
...
data-start="{{ optional($ot->starts_at)->format('M d, Y h:i A') }}"
data-end="{{ optional($ot->ends_at)->format('M d, Y h:i A') }}"
