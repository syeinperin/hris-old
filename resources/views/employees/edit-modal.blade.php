                    ...
                    <div class="p-4 tab-panels">
                                ...
                                <div class="span-12 mb-3 d-flex align-items-center gap-3">
                                    ...
                                    <div class="flex-fill">
                                        ...
                                        <input type="file" name="profile_picture" accept="image/*"
                                            class="form-control">
                                        <div class="form-text">
                                            Current: <a id="em-cur-photo" href="#" target="_blank"
                                                class="d-none">View</a>
                        ...
                        <section id="tab-edit-work" class="tab-panel" hidden>
                            <div class="form-grid">
                                ...
                                <div class="form-floating span-4">
                                    <select name="employment_type" id="employment_type_edit" class="form-select"
                                        required>
                                ...
                                <div class="form-floating span-4">
                                    <input type="date" name="employment_start_date"
                                        id="employment_start_date_edit" class="form-control" required>
                                    <label>Start Date *</label>
                                </div>
                                <div class="form-floating span-4">
                                    <input type="date" name="employment_end_date" id="employment_end_date_edit"
                                        class="form-control">
                        ...
                        <section id="tab-edit-education" class="tab-panel" hidden>
                            <div class="form-grid">
                                <div class="span-12">
                                    <h6 class="fw-bold mb-2">🎓 Educational Background</h6>
                                </div>
                                <div class="form-floating span-6">
                        ...
                        <section id="tab-edit-docs" class="tab-panel" hidden>
                            <div class="form-grid">
                                ...
                                {{-- MDR – PhilHealth --}}
                                <div class="form-floating span-6">
                                    <input type="file" name="mdr_philhealth_file" class="form-control"
                                        accept=".pdf,image/*">
                                    <label>MDR – PhilHealth</label>
                                    <div class="form-text">Current:
                                        <a id="em-cur-philhealth" href="#" target="_blank"
                                            class="d-none">Open</a>
                                ...
                                {{-- MDR – SSS --}}
                                <div class="form-floating span-6">
                                    <input type="file" name="mdr_sss_file" class="form-control"
                                        accept=".pdf,image/*">
                                    <label>MDR – SSS</label>
                                    <div class="form-text">Current:
                                ...
                                {{-- MDR – Pag-IBIG --}}
                                <div class="form-floating span-6">
                                    <input type="file" name="mdr_pagibig_file" class="form-control"
                                        accept=".pdf,image/*">
                                    <label>MDR – Pag-IBIG</label>
                                    <div class="form-text">Current:
                                        <a id="em-cur-pagibig" href="#" target="_blank"
                                            class="d-none">Open</a>
                                ...
                                <div class="span-12">
                                    ...
                                    <input type="file" name="medical_documents[]" class="form-control" multiple
                                        accept=".pdf,image/*">
                                    <div class="form-text">
                        ...
                        <div class="modal-footer bg-light border-top">
                            <button type="submit" class="btn btn-success"><i class="bi bi-save2 me-1"></i>
                                Update</button>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Prevent hidden required fields from blocking submit
    ...
    editModal?.addEventListener('show.bs.modal', (evt) => {
        ...
        let emp = {};
        try {
            emp = JSON.parse(btn.getAttribute('data-employee') || '{}');
        } catch {}
    ...
    window.handleEditSubmit = async (event) => {
        ...
        formData.append('_method', 'PUT'); // keep this
